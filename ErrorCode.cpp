...
const ErrorCode ErrorCode::EC_MAN_NO_AVAILABLE_INTERFACE = {258, "Manager API No available interface to perform the request"};

const ErrorCode ErrorCode::EC_ALREADY_DEPOSIT = {512, "Already deposit for the order"};
